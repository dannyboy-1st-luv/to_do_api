...
class CatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post cats_url, params: { cat: { age: @cat.age, favorite_food: @cat.favorite_food, name: @cat.name, person_id: @cat.person_id } }
    end
  ...
  test "should update cat" do
    patch cat_url(@cat), params: { cat: { age: @cat.age, favorite_food: @cat.favorite_food, name: @cat.name, person_id: @cat.person_id } }
